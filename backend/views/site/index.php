...
<head>
    ...
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/admin/public/assets/css/ace-part2.min.css" />
    <![endif]-->
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/admin/public/assets/css/ace-ie.min.css" />
    <![endif]-->
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="<?=$this->params['user']->face ? $this->params['user']->face : '/admin/public/assets/avatars/avatar.jpg'?>" alt="Jason's Photo" />
